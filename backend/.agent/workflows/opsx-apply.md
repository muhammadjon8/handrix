...
6. **Linear ticket setup** *(before each individual task)*
   ...
   **IMPORTANT: Create a brand new ticket for EVERY task. Never reuse or edit existing tickets.**
   ...
   Before starting each task (e.g., Task 2.4):
   ...
   - Description: include the task number, which spec it relates to, and what will be implemented
...
7. **Implement tasks (loop until done or blocked)**
   ...
   - **After completing the task:**
     - Record a row in `SESSION_LOG.md` at the root of the project with: task number/title, start time, finish time, files created/modified
